...
def create_executive_summary(wb, data):
    ...
    findings = [
        ...
        "   • Krystexxa: Providers with payments prescribe 401x more than those without",
        "   • Enbrel: 197x increase with payments",
        "   • Trelegy: 119x increase with payments",
        "   • Ozempic: 79x increase with payments",
        "",
        "2. PROVIDER VULNERABILITY:",
        "   • Physicians: 159.2% increase in prescribing when receiving payments",
        "   • Nurse Practitioners: 113.3% increase with payments",
        "   • Physician Assistants: 99.1% increase with payments",
        "",
