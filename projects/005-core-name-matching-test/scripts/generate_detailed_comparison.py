...
def main():
    ...
    tier1_df = load_and_fix_results('test_data/test_results_fuzzy_matching_85pct_threshold_latest.csv')
    tier2_df = load_and_fix_results('test_data/test_results_tier2_fuzzy_openai_90pct_latest.csv')
